...
import ServiceEllipse from "../../assets/themedSVGs/ServiceEllipse";
...
const IT_infra = [
  {
    ...
    Image: <img src={image1} alt="Image" width={231} height={86} />,
  },
  {
  ...
  //   Image: <img src={image1} width={231} height={86} />,
  // },
  {
...
const ContentArray = [
    ...
    children: [
      {
        ...
        Image: <img src={trc} alt="Image" width={231} height={86} />,
      },
      // {
      //   key: "AMS",
      ...
      //   Image: <img src={ams} width={231} height={86} />,
      // },
     ...
     
      {
        ...
        Image: <img src={pnms} alt="Image" width={231} height={86} />,
      },
  ...
  // },
  {
    ...
    Image: CTS,
    childurl: "https://cts.paradigmit.com/",
    ...
    //     Image: <img src={os} width={231} height={86} />,
    //   },
    //   {
    ...
    //       </p>
    //     ),
    //     Image: <img src={oso} width={231} height={86} />,
    //   },
    //   {
    //     key: "QualityControl",
    ...
    //       </p>
    //     ),
    //     Image: <img src={eer1} width={231} height={86} />,
    //   },
    //   {
    //     key: "CDM",
    ...
    //       </p>
    //     ),
    //     Image: <img src={cdm} width={231} height={86} />,
    //   },
    //   {
    //     key: "OtherServices",
    //     name: "Other Services",
    ...
    //       </p>
    //     ),
    //     Image: <img src={pharmacy} width={231} height={86} />,
    //   },
    //   {
    //     key: "Excellence",
    ...
    //       </p>
    //     ),
    //     Image: <img src={eer} width={231} height={86} />,
    //   },
    // ],
  },
  ...
  // },
  {
   ...
   secondName :"Expertise and Experience",
   secondCntent:   "Our team comprises highly skilled professionals with extensive experience in managing complex IT infrastructures. We stay up to date with the latest industry trends and best practices to deliver cutting-edge solutions that meet client specific needs.",
      Image: IT,
    children: IT_infra,
  },
  {
    key: "ImplementationPartnering",
    name: "Implementation Partnering",
    content:"Implementation Partnering involves collaborating with an external organization or consultant to deploy and integrate new systems, processes, or solutions within a business.",
   Image: IP,
  },
  // {
  //   key: "BPO",
  ...
  //   content:
  //     "ParadigmIT has proven experience in building Business Process Outsourcing teams for various industry segments and executing and sustaining them long-term successfully. With a wide range of technology services that ParadigmIT offers across various technology platforms, It has expertise in adding value in every engagement to help their customers improve their existing business processes through Automation. With 18+ years of EDC (Electronic Data Capture) platforms implementations as their flagship service experience in the Clinical trial domain, ParadigmIT excelled in setting up high-performing BPO teams around clinical data-based processes execution.",
  //   Image: BPO,
  //   children: [
  //     {
  //       key: "UserAdmin&SiteAdmin",
  //       name: "User Admin & SiteAdmin",
  //       content:
  //         " The main objective of the project is to maintain User & Site administration for a leading EDC platform and it involves Creation of Accounts, Updating, Activation and Inactivation of accounts and sites for specified study, role(s) and environment(s). These accounts are used for Clinical Trials under the Health Care domain. The Account and Site administration process is performed according to the client development Standards and Guidelines.",
  //       Image: <img src={image1} width={231} height={86} />,
  //     },
  //     {
  //       key: "MasterDataManagementSupport",
  //       name: "Master Data Management Support",
  //       content:
  //         "The purpose of this project is to review standardized site records from across the EDC platform which perform the below tasks:Matching Review – To confirm whether one or more site records correctly match a master record. Presentation Values – To review a cluster of site records, and choose a display name & address, that accurately represents all records in the cluster. PI Matching – To confirm that a person was the principal investigator for a given combination of study & site. Manual Matching – To use keywords to find and group site records that represent the same healthcare facility",
  //       Image: <img src={image1} width={231} height={86} />,
  //     },
  //     {
  //       key: "DataextractionservicefortrainingAIalgorithms",
  //       name: "Data extraction service for training AI algorithms",
  //       content:
...
const Index = (props) => {
  ...
  const [currentState, setCurrentState] = useState("ClinicalTrialServices");
  ...
  const switchContent = () => {
    setCurrentState((prevState) => {
      let pIndex = ContentArray?.findIndex((s) => s.key === prevState);
      return pIndex === ContentArray?.length - 1
        ? ContentArray.at(0).key
        : ContentArray.at(pIndex + 1).key;
    });
  };
  ...
  const onExplore = (content) => {
    if (content?.childurl) {
      window.open(content.childurl, '_blank');
      return;
    }
  ...
  // if (child.isActive) return <div>child</div>;
  return (
    <main className="grid grid-cols-1   grid-rows-[80px_calc(100%_-80px_-8vh)_8vh] w-screen h-screen">
      {/* <Tobbar /> */}
      <div></div>
      {width > 648 ? (
        <div
        ...
        >
          <div className="flex flex-1 justify-end gap-2 mr-[2rem] items-end">
            {child?.isActive ?currentContent?.key !== "CyberSecurity" &&  (
              <div className="flex   lg:text-2xl text-3xl text-[#2086FE]">
                {currentContent?.name}
              </div>
            ) : (
              [
                <div className="flex   text-3xl text-#252D2D">
                  ParadigmIT
                </div>,
          ...
          <div className="flex w-full h-full overflow-hidden gap-1  max-h-min">
            <div className="w-[40%] overflow-hidden flex justify-start items-start h-full">
              <div className="w-full h-full  overflow-hidden relative grid grid-cols-1 place-content-start justify-start items-center place-items-end">
                {!child?.isActive ? currentContent?.key !== "MaintenanceServices"&& (
                  <ServiceEllipse
                    onBack={null}
                    services={ContentArray}
                  ...
                  <ServiceEllipse
                    ...
                    services={child?.children || []}
                    activeIndex={child.activeIndex}
                    setActiveIndex={(index) => {
                      console.log("active index", index);
                      setChild((prev) => ({ ...prev, activeIndex: index }));
                    }}
                  />
                )}
              </div>
              <div className="pr-32 pt-20">
                <img src={polygon}  id="PolygonFilled"  className="aspect-square  absolute w-[60px] opacity-1 -translate-y-[100px]"/>
              </div>
              {/* <div className="pr-40 pt-20">
                <img
                  id="PolygonFilled"
                  src={pg2}
                  className="aspect-square  absolute w-[60px] opacity-1 -translate-y-[100px]"
                />
              </div>  */}
                        </div>

            {/* <div className="flex -rotate-[40deg] -translate-x-8">
          <div className="w-[300px] h-[250px] bg-[#2086FE] border rounded-[50%]">
            <div className="w-[293px] h-[245px] bg-white border rounded-[50%]"></div>
          </div>
        </div> */}
            {!child?.isActive ? (
              <div className="w-[60%] h-full align-middile px-[10px]">
                <AnimatePresence>
                  <motion.div
                    key={currentContent?.key|| Math.random()}
                    variants={fadeInOutVariants}
                    animate="in"
                    initial="initial"
                    exit="out"
                  >
                    <div className="  lg:text-2xl text-[#2086FE]">
                      {currentContent?.name}
                    </div>
                    <p className="text-left  pr-12 mt-5 justify-content max-h-[1200px] ">
                      {currentContent?.content}
                    </p>
                    <h3 className="pt-2 text-[#2086FE]"> {currentContent?.secondName}</h3>
                    <p className="pt-1 ">{currentContent?.secondCntent}</p>
                  </motion.div>
                </AnimatePresence>

                <div>
                {currentContent ?.key !== "ImplementationPartnering" &&   (
    <button
      onClick={() => {
        onExplore(currentContent);
      }}
      className="text-white font-semibold bg-[#2086FE] w-[100px] mt-10 h-8 text-center items-center border rounded-md"
    >
      Explore
    </button>
  )}
                  ...
                  <AnimatePresence>
                    <motion.div
                      ...
                      exit="out"
                    >
                      {/* <div className="flex justify-end mr-[7.25rem]"> */}
                      {/* <img
                        src={currentContent.Image.props.src}
                        width={231}
                        height={86}
              ...
              <div className="w-[60%] h-full align-middile px-[10px]">
                <AnimatePresence>
                  <motion.div
                    ...
                    exit="out"
                  >
                    <div className=" text-2xl text-[#2086FE]">
                      {
                        child.children?.find((c) => c.key === child.activeIndex)
                          ?.name
                      }
                    </div>
                    <p className="text-left mt-5 justify-content max-h-[200px] overflow-hidden">
                      {
                        child.children?.find((c) => c.key === child.activeIndex)
                          ?.content
                      }
                ...
                <div>
                  ...
                  className="text-white font-semibold bg-[#2086FE] w-[100px] mt-6 h-8 text-center items-center border rounded-md"
                >
                  Explore
                </button> */}
                  <AnimatePresence>
        ...
        >
          <div className="flex flex-1 justify-end gap-2 mr-[2rem] items-end">
            {child?.isActive ? currentContent?.key !== "CyberSecurity" && (
              <div className="flex font-bold text-3xl text-[#2086FE]">
                {currentContent?.name}
              </div>
            ) : (
              [
                <div className="flex font-bold text-3xl text-#252D2D">
                  ParadigmIT
                </div>,
                <div className="flex font-bold text-3xl text-[#2086FE]">
                  Services
              ...
              <div className="w-[60%] h-full align-middile px-[10px]">
                <AnimatePresence>
                  <motion.div
                    ...
                    exit="out"
                  >
                    <div className="font-bold text-2xl text-[#2086FE]">
                      {currentContent?.name}
                    </div>
                    <p className="text-left mt-5 justify-content max-h-[1200px] ">
                      {currentContent?.content}
                    </p>
                  </motion.div>
                </AnimatePresence>
